define("UsrHRRequest_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_abr5ifp_caption)#",
					"color": "default",
					"disabled": false,
					"clicked": {
			...
			{
				"operation": "insert",
				"name": "MenuItem_navpb3n",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_navpb3n_caption)#",
					"items": []
				},
				"parentName": "Button_abr5ifp",
				"propertyName": "menuItems",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "MenuItem_jvx9i95",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_jvx9i95_caption)#",
					"clicked": {
						"request": "crt.OpenPageRequest",
						"params": {
							"schemaName": "AppFeatureState_ListPage"
						}
					}
				},
				"parentName": "MenuItem_navpb3n",
				"propertyName": "items",
				"index": 0
			},
			{
